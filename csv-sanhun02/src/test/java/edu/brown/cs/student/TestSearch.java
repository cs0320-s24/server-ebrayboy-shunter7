...
public class TestSearch {
  ...
  public void testBasic() throws IOException, FactoryFailureException {
    Util testBasic =
        new Util(
            "/Users/elybrayboy/Desktop/cs32/sprints/csv-elybrayboy/data/census/income_by_race.csv",
            "White",
            1,
            true);
  ...
  public void testEarnings() throws IOException, FactoryFailureException {
    Util earningsTest =
        new Util(
            "/Users/elybrayboy/Desktop/cs32/sprints/csv-elybrayboy/data/census/dol_ri_earnings_disparity.csv",
            "RI",
            null,
            true);
  ...
  public void testEducation() throws IOException, FactoryFailureException {
    Util eduTest =
        new Util(
            "/Users/elybrayboy/Desktop/cs32/sprints/csv-elybrayboy/data/census/postsecondary_education.csv",
            "Brown University",
            null,
            true);
